...
export const ROCKETS = {
  ...
  sls: {
    ...
    diameter: 8.4,
    payloadLeo: 95_000,
    reusable: "Tidak (Artemis)",
    firstFlight: 2022,
    fuel: "Hidrogen / LOX + booster padat",
    stages: [
      {
        id: "srb",
        nama: "2× SRB (booster padat)",
        mesin: "Solid",
        engines: 2,
        massaStruktur: 164_000,
        massaBB: 2_512_000,
        thrust: 32_000_000,
        ispVac: 269,
        burnTime: 126,
        height: 40,
        colors: { body: 0xe8e6e0, accent: 0x2a2a2a },
        exhaustScale: 1.2,
        layout: "sls-srb",
      },
      {
        id: "core",
        nama: "Core Stage (4× RS-25)",
        mesin: "RS-25",
        engines: 4,
        massaStruktur: 85_000,
        massaBB: 1_265_000,
        thrust: 7_440_000,
        ispVac: 452,
        burnTime: 484,
        height: 50,
        colors: { body: 0xde6b2f, accent: 0x8b4513 },
        exhaustScale: 0.9,
      },
      {
        id: "icps",
        ...
        height: 12,
        diameterScale: 0.52,
        colors: { body: 0xf0f0ec, accent: 0x555555 },
        exhaustScale: 0.4,
      },
      {
        id: "orion",
        nama: "Orion spacecraft",
        mesin: "—",
        engines: 0,
        massaStruktur: 10_400,
        massaBB: 0,
        thrust: 0,
        ispVac: 0,
        burnTime: 0,
        height: 10,
        diameterScale: 0.45,
        colors: { body: 0xe8e8e8, accent: 0x336699 },
        isPayload: true,
      },
    ],
  },
